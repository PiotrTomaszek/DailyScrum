...
namespace DailyScrum.Migrations
{
    ...
    [Migration("20210521183051_added messages to team")]
    partial class addedmessagestoteam
    {
            ...
            modelBuilder.Entity("DailyScrum.Areas.Identity.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("TeamRoleScrumRoleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TeamRoleScrumRoleId");

                    b.ToTable("AspNetUsers");
                });

            modelBuilder.Entity("DailyScrum.Areas.Identity.Data.ScrumRole", b =>
                {
                    b.Property<int>("ScrumRoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DailyScrum.Areas.Identity.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("DailyScrum.Areas.Identity.Data.ScrumRole", "TeamRole")
                        .WithMany()
                        .HasForeignKey("TeamRoleScrumRoleId");
