...
namespace DailyScrum.Migrations
{
    ...
    [Migration("20210504123153_fixed db v1")]
    partial class fixeddbv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyScrum.Models.Database.ScrumTask", b =>
                {
                    ...
                    b.Property<int?>("BoardScrumTaskBoardId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BoardScrumTaskBoardId");
            ...
            modelBuilder.Entity("DailyScrum.Models.Database.ScrumTaskBoard", b =>
                {
                    b.Property<int>("ScrumTaskBoardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DailyScrum.Models.Database.ScrumTask", b =>
                {
                    b.HasOne("DailyScrum.Models.Database.ScrumTaskBoard", "Board")
                        .WithMany()
                        .HasForeignKey("BoardScrumTaskBoardId");

                    b.HasOne("DailyScrum.Models.Database.DailyMeeting", null)
                        .WithMany("Tasks")
                        .HasForeignKey("DailyMeetingId");

                    b.HasOne("DailyScrum.Areas.Identity.Data.ApplicationUser", "Executor")
                        .WithMany("Tasks")
